<?php !isset($login) && exit('please login amh.'); ?>
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		acd2 = new Date();
		acd2ok=acd2.getTime();
		WindowLocation('index.php?c=yaheiphp&speed=' +(acd2ok-acd1ok)+'#w_networkspeed');
	</script>
<?php
}
//网速测试-结束
...
if($_GET['act'] == "cpu_percentage"){echo "<center><b><font face='Arial' color='#666666' size='3'>图片加载慢，请耐心等待！</font></b><br /><br />";foreach( $data as $k => $v ) {echo '<img src="' . makeImageUrl( $k, $v ) . '" style="width:360px;height:240px;border: #CCCCCC 1px solid;background: #FFFFFF;margin:5px;padding:5px;" />';}echo "</center>";exit();}
...
<!--
* {font-family:Arial; }
body{ margin: 10px 0px; padding: 0; background-color:#fafafa;font-size:12px;font-family:Arial}
h1 {font-size: 26px; padding: 0; margin: 0; color: #333333; font-family: "Lucida Sans Unicode","Lucida Grande",sans-serif;}
h1 small {font-size: 11px; font-weight: bold; }
...
#page {width: 960px; padding: 0 auto;  text-align: left;}
...
function getJSONData()
{
	...
	$.getJSON(url_token('/index.php?c=yaheiphp&act=rt&callback=?'), displayData);
}
...
<div id="page">
	...
	<table>
		<tr>
			...
			<th class="w_top"><a href="/index.php?c=yaheiphp#w_php">PHP参数</a></th>
			<th class="w_top"><a href="/index.php?c=yaheiphp#w_module">组件支持</a></th>
			<th class="w_top"><a href="/index.php?c=yaheiphp#w_module_other">第三方组件</a></th>
			<th class="w_top"><a href="/index.php?c=yaheiphp#w_db">数据库支持</a></th>
			<th class="w_top"><a href="/index.php?c=yaheiphp#w_performance">性能检测</a></th>
			<th class="w_top"><a href="/index.php?c=yaheiphp#w_networkspeed">网速检测</a></th>
			<th class="w_top"><a href="/index.php?c=yaheiphp#w_MySQL">MySQL检测</a></th>
			<th class="w_top"><a href="/index.php?c=yaheiphp#w_function">函数检测</a></th>
			<th class="w_top"><a href="/index.php?c=yaheiphp#w_mail">邮件检测</a></th>
...
$phpSelf .= '?c=yaheiphp';	// amh modules
$disFuns=get_cfg_var("disable_functions");
?>
...
<table>
  ...
  <tr>
    ...
    <?php echo (false!==eregi("phpinfo",$disFuns))? '<font color="red">×</font>' :"<a href='/index.php?c=index&a=phpinfo' target='_blank'>PHPINFO</a>";?>
    </td>
...
<form action="<?php echo $_SERVER[PHP_SELF]."?c=yaheiphp#bottom";?>" method="post">
<!--服务器性能检测-->
<table>
  ...
  ?>
	...
	<table>
		<tr>
			...
			<td class="w_foot"><a href="/index.php?c=yaheiphp#w_top">返回顶部</a></td>
		</tr>
	</table>
